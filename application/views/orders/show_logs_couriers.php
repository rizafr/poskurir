...
<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header"><i class="fa fa-table"></i> Data Historis Order Berdasarkan Pengantar</h3>
</div>
<div class="row">
	<div class="col-lg-12">
				...
				if($curs != 0)
				{
					foreach($curs as $key => $data)
					{
						...
						<tr class="odd gradeX">
							...
							<td>
							  <div class="btn-group">
								  <a class="btn btn-primary" href="'.base_url().'order/logs_detail_curs/'.$order[$key]->order_id.'">'.status($data->status_delv_id).'</a>
							  </div>
							</td>
						</tr>';
