	...
	<div class="col-lg-12">
		...
		?>
		  ...
		  <br>
			  ...
			  <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>transaksi/month" method="post">
				  <div class="form-group">
					  <label class="control-label col-lg-2" for="exampleInputPassword2">Choose Month</label>
					  <div class="input-group col-lg-6">
						<?php
						if(!empty($from))
						{
						?>
						  <div class="btn btn-default from"><?php echo substr(tgl($from),3); ?></div> *klik jika akan merubah
						  <br><br>
						<?php
						}
						?>
						...
						<select name='month' class="form-control m-bot15">
							<?php
								for($i=1;$i<13;$i++)
								{
									echo "<option value='$i' ".($i == date("n") ? 'selected' : '').">".bulan($i)."</option>";
								}
							?>
						</select>
						</div>
