...
<div class="row">
	<div class="col-lg-12">
		...
		?>
		  ...
		  <br>
			  <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>transaksi/day" method="post">
				  <div class="form-group">
					  <label class="control-label col-lg-2" for="exampleInputPassword2">Choose Date</label>
					  <div class="input-group col-lg-5">
						<?php
						if(!empty($from))
						{
						?>
						  <div class="btn btn-default from"><?php echo tgl($from); ?></div> *klik jika akan merubah
						  <br><br>
						<?php
						}
						?>
