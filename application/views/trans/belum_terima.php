...
<div class="row">
	<div class="col-lg-12">
		<h3 class="page-header"><i class="fa fa-table"></i> Tagihan Order Yang Belum Diterima</h3>
</div>
<div class="row">
	<div class="col-lg-12">
		...
		?>
		  ...
		  <br>
			  <form class="form-horizontal" role="form" action="<?php echo base_url(); ?>transaksi/not_receive_yet" method="post">
			...
			<table id='pagging' class="table table-bordered table-striped table-advance table-hover">
				...
				<tfoot>
					<tr>
						<th colspan="4"><p align="right">Total Seluruh Transaksi</p></th>
